...
#reads data dffrom data folder , the sopng nad the log fata  nad loads to the table.
...
def process_song_file(cur, filepath):
    ...
    """
    -The fuction reads the song file and extracts needed data for song and artist table, and writes tit to the table to dadfabase
    --
    :param cur:  the cursor varible
...
def process_log_file(cur, filepath):
    ...
    :param cur: the cursor varible
    :param filepath:  the file path to the slog file
    :return:
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
